...
param eventhubContainerName string = 'events'
...
resource eventhub_container 'Microsoft.Storage/storageAccounts/blobServices/containers@2021-02-01' = {
    name: '${sa.name}/default/${eventhubContainerName}'
}
